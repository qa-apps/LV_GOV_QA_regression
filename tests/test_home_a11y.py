...
@pytest.mark.ui
def test_auto_1_a(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_1_b(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_1_c(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_1_d(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_1_e(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_11_a(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
    expect(page.locator(hp.logo).first).to_be_visible()
...
@pytest.mark.ui
def test_auto_11_b(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
    expect(page.locator(hp.search_input).first).to_be_visible()
...
@pytest.mark.ui
def test_auto_11_c(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
    expect(page.locator(hp.login_link).first).to_be_visible()
...
@pytest.mark.ui
def test_auto_11_d(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
    expect(page.locator(hp.services_menu).first).to_be_visible()
...
@pytest.mark.ui
def test_auto_11_e(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
    expect(page.locator(hp.all_services_link).first).to_be_visible()
