...
@pytest.mark.ui
def test_auto_6_a(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_6_b(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_6_c(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_6_d(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_6_e(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
