...
@pytest.mark.ui
def test_auto_4_a(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_4_b(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_4_c(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_4_d(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
...
@pytest.mark.ui
def test_auto_4_e(page: Page, base_url: str):
    hp = HomePage(page)
    hp.open(base_url)
    hp.accept_cookies()
